...
//           <Route path="/home" element={<ProtectedRoute element={<HomePage />} />} />
//           <Route path="/artworks" element={<ProtectedRoute element={<ArtworkPage />} />} />
//           <Route path="/artworks/:id" element={<ProtectedRoute element={<ArtworkDetailsPage addItemToCart={addItemToCart} />} />} />
//           <Route path="/cart" element={<ProtectedRoute element={<CartPage cartItems={cartItems} updateItemQuantity={updateItemQuantity} removeItemFromCart={removeItemFromCart} />} />} />
//           <Route path="/add-art" element={<ProtectedRoute element={<AddArtPage />} />} />
//           <Route path="/events" element={<ProtectedRoute element={<EventsPage events={events} />} />} />
//           <Route path="/events/:id" element={<ProtectedRoute element={<EventDetailPage />} />} />
//           <Route path="/create-event" element={<ProtectedRoute element={<CreateEventPage addEvent={addEvent} />} />} />
//           <Route path="/my-events" element={<ProtectedRoute element={<MyEventsList />} />} />
//           <Route path="/dashboard" element={<ProtectedRoute element={<Dashboard />} />} />
//           <Route path="/messaging" element={<ProtectedRoute element={<Messaging />} />} />
//           <Route path="/profile" element={<ProtectedRoute element={<UserProfile />} />} />
//           <Route path="/book-ticket" element={<ProtectedRoute element={<TicketBookingPage />} />} />
//           <Route path="/checkout" element={<ProtectedRoute element={<CheckoutPageModal />} />} />
